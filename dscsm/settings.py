"""
Django settings for dscsm project.
...
SECRET_KEY = 'django-insecure-#5)oup!fx%c5s!jj0i%nrexwcmgi8l76zs(oj47b$9*h)ox_hx'
...
WSGI_APPLICATION = 'dscsm.wsgi.application'
